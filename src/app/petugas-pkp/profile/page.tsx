...
export default function PetugasPKPProfilePage() {
  ...
  return (
    <div className="space-y-6 max-w-2xl">
      ...
      <div>
        <h1 className="text-3xl font-bold text-gray-900">Profil</h1>
        <p className="text-gray-600 mt-2">Kelola informasi akun Petugas PKP Anda</p>
      </div>
      ...
      <Card>
        ...
        <CardContent>
          <div className="grid grid-cols-2 gap-4 text-sm">
            <div>
              <p className="text-gray-500">Bergabung pada</p>
